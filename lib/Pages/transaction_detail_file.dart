  ...
  TypeResult getType() {
    ...
    switch (transaction.transaction_type) {
      ...
      case "withdrawal":
        ...
        break;
      case "safelock":
        result.type = "Safelock";
        result.key = "Lock to";
        result.value = "Upaychat";
        break;
      case "wallet":
        result.type = "Added";
        result.key = "Added to";
      ...
      case "virtualCardWithdraw":
        result.key = "Deposit to";
        result.type = "Withdraw Card";
        result.value = "your wallet";
        break;
      case "virtualCard":
        result.type = "Card Charge";
        result.key = "Charge to";
        result.value = "Your virtual card";
        break;
      case "takeback":
