        ...
        body: TabBarView(
          children: [
            Container(
              ...
              child:
                  SingleChildScrollView(child: _body(context, _SHOW_BANKLIST)),
            ),
            Container(
              color: MyColors.base_green_color_20,
              height: MediaQuery.of(context).size.height,
              width: MediaQuery.of(context).size.width,
              child:
                  SingleChildScrollView(child: _body(context, _SHOW_CARDLIST)),
            ),
          ],
        ),
      ),
        ...
        onTap: () {
          if (isAdd) {
            Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => AddBankFile(from: 'add')))
                .then((data) {
                            ...
                            Row(
                              children: [
                                Expanded(
                                  flex: 2,
                                  child: Text(
                                    CommonUtils.bankNumberHolder(
                                        banklist[index].account_no),
                                    style: TextStyle(
                                      color: MyColors.grey_color,
                                      fontSize: 18,
                                      fontFamily: 'Doomsday',
        ...
        onTap: () {
          if (isAdd) {
            Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => AddCardFile(from: 'add')))
                .then((data) {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        title: Text(
          'Confirm',
          style: TextStyle(
              color: Colors.black54, fontSize: 18, fontFamily: "Doomsday"),
        ),
        content: Text(
