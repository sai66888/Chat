                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    contentPadding: EdgeInsets.fromLTRB(
                        10, 16, 10, 10), // control your hints text size
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    PopupMenuButton(
                      ...
                      itemBuilder: (context) => banklist
                          .map((bank) => PopupMenuItem(
                              value: bank, child: Text(bank.account_no)))
                          .toList(),
                    ),
                  ],
                ),
                  ...
                  onPressed: () {
                    try {
                      if (amountController.text.isEmpty) {
                        ...
                        double withdrawAmount = double.parse(
                        ...
                        if (withdrawAmount < 500.0) {
                          ...
                          if (withdrawAmount > Globals.walletbalance) {
                            ...
                            if (bankName == '') {
                              ...
                              CommonUtils.errorToast(
                                  context, "Please confirm account number");
                            } else if (accountNumber != confirmAccountNumber) {
                              CommonUtils.errorToast(
                                  context, "Account Number not match.");
                            } else {
                              if (isNew) {
                                _callApiForAddOrUpdate(
                                    'addbank', withdrawAmount);
                              } else {
    ...
    if (Globals.isOnline) {
      try {
        ...
        AddMoneyToWalletModel result =
            await _request.search(withdrawAmountPayment.toString());
        context.loaderOverlay.hide();
        if (result.status == "true") {
          setState(() {
