...
class AddUserProfileState extends State<AddUserProfile>
  ...
  void initState() {
    ...
    userNameController.text = widget.map != null
        ? widget.map!['firstname'] + widget.map!['lastname']
        : '';
            ...
            children: [
              ...
              CupertinoDateTextBox(
                ...
                hintText: birthday != null
                    ? CommonUtils.formattedDate(birthday!)
                    : CommonUtils.formattedDate(DateTime.now()),
                fontSize: 18,
              ),
              ...
              Container(
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    ...
                    else if (CommonUtils.isEmpty(userNameController, 2)) {
                      Navigator.pop(context);
                      CommonUtils.errorToast(context, StringMessage.username_Error);
                    }
                    else{
                      RegisterValidation.userNameValidation(context,
                          userNameController, birthday!, widget.map!, _image);
                    }
