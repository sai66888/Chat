  ...
  LoginModel.map(dynamic obj) {
    if (obj != null) {
      ...
      if (status == "true") {
        ...
        this.street = obj['data']['street'].toString();
        this.house_no = obj['data']['house_no'].toString();
        this.city = obj['data']['city'].toString();
        this.state = obj['data']['state'].toString();
        this.zipcode = obj['data']['zipcode'].toString();
        this.bvn = obj['data']['bvn'].toString();
